...
const MODEL_PROFILES = {
  'gsd-planner': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-roadmapper': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-executor': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-phase-researcher': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-project-researcher': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-research-synthesizer': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-debugger': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-codebase-mapper': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-verifier': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-plan-checker': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-integration-checker': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-nyquist-auditor': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-ui-researcher': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-ui-checker': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
  'gsd-ui-auditor': { quality: 'gpt-5.4', balanced: 'gpt-5.4', budget: 'gpt-5.4' },
};
